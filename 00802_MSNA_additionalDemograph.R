...
template_df <- read.csv(template_analysisplan_file, stringsAsFactors = F)
 ...
 freq_admin0 <- response_updated_cluster %>%
    summarise(
      ...
      freq_sante_2_malade_oui_0_5_filles = sum(sum_sante_2_malade_oui_0_5_filles * weights_sampling, na.rm =  T) / sum(ig_6_hh_membres_tot * weights_sampling, na.rm = T),
      freq_sante_2_malade_oui_0_5_garcons = sum(sum_sante_2_malade_oui_0_5_garcons * weights_sampling, na.rm =  T) / sum(ig_6_hh_membres_tot * weights_sampling, na.rm = T),
      ...
      freq_sante_5_5plus_malades.fievre_garcons_18plus = sum(sum_sante_5_5plus_malades.fievre_garcons_5_17 * weights_sampling, na.rm = T)/ sum(sum_agegrp_18plus_hommes * weights_sampling, na.rm = T),
      ...
      freq_protect_9_garcon = sum(sum_protect_9_garcon * weights_sampling, na.rm = T)/sum(sum_agegrp_4_18 * weights_sampling, na.rm = T),
      freq_protect_9_fille = sum(sum_protect_9_fille * weights_sampling, na.rm = T)/sum(sum_agegrp_4_18 * weights_sampling, na.rm = T),
      freq_protect_10.agric = sum(sum_protect_10.agric * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.peche =  sum(sum_protect_10.peche * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.elevage = sum(sum_protect_10.elevage * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.carriere = sum(sum_protect_10.carriere * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.petit_commerce = sum(sum_protect_10.petit_commerce * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.restauration = sum(sum_protect_10.restauration * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.artisanat = sum(sum_protect_10.artisanat * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.travaux_domestiques = sum(sum_protect_10.travaux_domestiques * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.construction = sum(sum_protect_10.construction * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.transport = sum(sum_protect_10.transport * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.recrutes = sum(sum_protect_10.recrutes * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.prostitution = sum(sum_protect_10.prostitution * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.autre = sum(sum_protect_10.autre * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),
      protect_10.nsp = sum(sum_protect_10.nsp * weights_sampling, na.rm = T)/ sum(sum_protect_9 * weights_sampling, na.rm = T),

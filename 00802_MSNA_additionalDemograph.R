...
response_updated_cluster <- response_updated_cluster%>%
  mutate(
    ...
    sum_educ_3_presence_18_19.garcons.12m = rowSums(select(.,matches("^sum_educ_3_presence_18_19.garcons.*12m$")), na.rm = T),
...
freq_admin0 <- response_updated_cluster %>%
  summarise(
    freq_educ_2_inscrit_18_19.total= sum(sum_educ_2_inscrit_18_19.total * weights_sampling, na.rm = T) / sum(school_age_enfants * weights_sampling, na.rm = T),
    ...
    freq_educ_3_presence_18_19.total.0m = sum(sum_educ_3_presence_18_19.total.0m * weights_sampling, na.rm=T) / sum(school_age_enfants * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.0m_3m = sum(sum_educ_3_presence_18_19.total.0m_3m * weights_sampling, na.rm=T) / sum(school_age_enfants * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.12m = sum(sum_educ_3_presence_18_19.total.12m * weights_sampling, na.rm=T) / sum(school_age_enfants * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.3m_6m = sum(sum_educ_3_presence_18_19.total.3m_6m * weights_sampling, na.rm = T) / sum(school_age_enfants * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.6m_12m = sum(sum_educ_3_presence_18_19.total.6m_12m* weights_sampling, na.rm =T) / sum(school_age_enfants * weights_sampling, na.rm = T),

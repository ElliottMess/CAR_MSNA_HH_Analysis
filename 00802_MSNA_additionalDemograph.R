...
response_updated_cluster <- response_updated_cluster%>%
  mutate(
    sum_educ_2_inscrit_18_19.total= sum(rowSums(select(.,starts_with("sum_educ_2_inscrit_18_19.")))*weights_sampling, na.rm = T),
    sum_educ_2_inscrit_18_19.filles = sum(rowSums(select(.,starts_with("sum_educ_2_inscrit_18_19.filles")))*weights_sampling, na.rm = T),
    sum_educ_2_inscrit_18_19.garcons = sum(rowSums(select(.,starts_with("sum_educ_2_inscrit_18_19.garcons")))*weights_sampling, na.rm = T),
    
    sum_educ_2_inscrit_18_19.filles_7_12 = sum(sum_educ_2_inscrit_18_19.filles_7_12*weights_sampling, na.rm = T),
    sum_educ_2_inscrit_18_19.filles_13_18 = sum(sum_educ_2_inscrit_18_19.filles_13_18*weights_sampling, na.rm = T),
    sum_educ_2_inscrit_18_19.garcons_7_12 = sum(sum_educ_2_inscrit_18_19.garcons_7_12*weights_sampling, na.rm = T),
    sum_educ_2_inscrit_18_19.garcons_13_18 = sum(sum_educ_2_inscrit_18_19.garcons_13_18*weights_sampling, na.rm=T),

    sum_educ_3_presence_18_19.total.0m = sum(rowSums(select(.,ends_with(".0m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.total.0m_3m = sum(rowSums(select(.,ends_with("0m_3m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.total.12m = sum(rowSums(select(.,ends_with("12m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.total.3m_6m = sum(rowSums(select(.,ends_with("3m_6m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.total.6m_12m = sum(rowSums(select(.,ends_with("6m_12m")))*weights_sampling, na.rm = T),
    
    sum_educ_3_presence_18_19.filles.0m = sum(rowSums(select(.,matches("^sum_educ_3_presence_18_19.filles.*0m$")))*weights_sampling, na.rm = T) ,
    sum_educ_3_presence_18_19.filles.0m_3m = sum(rowSums(select(.,matches("^sum_educ_3_presence_18_19.filles.*0m_3m$")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.filles.12m = sum(rowSums(select(.,matches("^sum_educ_3_presence_18_19.filles.*12m$")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.filles.3m_6m = sum(rowSums(select(.,matches("^sum_educ_3_presence_18_19.filles.*3m_6m$")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.filles.6m_12m = sum(rowSums(select(.,matches("^sum_educ_3_presence_18_19.filles.*6m_12m$")))*weights_sampling, na.rm = T),
    
    sum_educ_3_presence_18_19.garcons.0m = sum(rowSums(select(.,starts_with("sum_educ_3_presence_18_19.garcons.0m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.garcons0m_3m = sum(rowSums(select(.,starts_with("sum_educ_3_presence_18_19.garcons.0m_3m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.garcons.12m = sum(rowSums(select(.,starts_with("sum_educ_3_presence_18_19.garcons.12m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.garcons.3m_6m = sum(rowSums(select(.,starts_with("sum_educ_3_presence_18_19.garcons.3m_6m")))*weights_sampling, na.rm = T),
    sum_educ_3_presence_18_19.garcons.6m_12m = sum(rowSums(select(.,starts_with("sum_educ_3_presence_18_19.garcons.6m_12m")))*weights_sampling, na.rm = T)
  )
...
freq_admin0 <- response_updated_cluster %>%
  summarise(
    freq_educ_2_inscrit_18_19.total= sum(sum_educ_2_inscrit_18_19.total, na.rm = T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles + sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_2_inscrit_18_19.filles = sum(sum_educ_2_inscrit_18_19.filles, na.rm = T)/ sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles) * weights_sampling, na.rm = T),
    freq_educ_2_inscrit_18_19.garcons =  sum(sum_educ_2_inscrit_18_19.garcons, na.rm = T)/ sum((sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    
    freq_educ_2_inscrit_18_19.filles_7_12 = sum(sum_educ_2_inscrit_18_19.filles_7_12, na.rm = T)/ sum(sum_agegrp_7_12_filles * weights_sampling, na.rm = T),
    freq_educ_2_inscrit_18_19.filles_13_18 = sum(sum_educ_2_inscrit_18_19.filles_13_18, na.rm = T)/ sum(sum_agegrp_13_18_filles * weights_sampling, na.rm = T),
    freq_educ_2_inscrit_18_19.garcons_7_12 = sum(sum_educ_2_inscrit_18_19.garcons_7_12, na.rm = T)/ sum(sum_agegrp_7_12_garcons*weights_sampling, na.rm = T),
    freq_educ_2_inscrit_18_19.garcons_13_18 = sum(sum_educ_2_inscrit_18_19.garcons_13_18, na.rm =T) / sum(sum_agegrp_13_18_garcons*weights_sampling, na.rm=T),

    freq_educ_3_presence_18_19.total.0m = sum(sum_educ_3_presence_18_19.total.0m, na.rm=T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles + sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.0m_3m = sum(sum_educ_3_presence_18_19.total.0m_3m, na.rm=T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles + sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.12m = sum(sum_educ_3_presence_18_19.total.12m, na.rm=T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles + sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.3m_6m = sum(sum_educ_3_presence_18_19.total.3m_6m, na.rm = T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles + sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.total.6m_12m = sum(sum_educ_3_presence_18_19.total.6m_12m, na.rm =T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles + sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    
    freq_educ_3_presence_18_19.filles.0m = sum(sum_educ_3_presence_18_19.filles.0m, na.rm=T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.filles.0m_3m = sum(sum_educ_3_presence_18_19.filles.0m_3m, na.rm = T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.filles.12m = sum(sum_educ_3_presence_18_19.filles.12m, na.rm =T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.filles.3m_6m = sum(sum_educ_3_presence_18_19.filles.3m_6m, na.rm = T) / sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.filles.6m_12m = sum(sum_educ_3_presence_18_19.filles.6m_12m, na.rm = T)/ sum((sum_agegrp_7_12_filles+sum_agegrp_13_18_filles) * weights_sampling, na.rm = T),
    
    freq_educ_3_presence_18_19.garcons.0m = sum(sum_educ_3_presence_18_19.garcons.0m, na.rm = T)/ sum((sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons0m_3m =sum( sum_educ_3_presence_18_19.garcons0m_3m, na.rm=T) / sum((sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons.12m = sum(sum_educ_3_presence_18_19.garcons.12m, na.rm = T) / sum((sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons.3m_6m = sum(sum_educ_3_presence_18_19.garcons.3m_6m, na.rm=T) / sum((sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons.6m_12m = sum(sum_educ_3_presence_18_19.garcons.6m_12m, na.rm = T) / sum((sum_agegrp_7_12_garcons+sum_agegrp_13_18_garcons) * weights_sampling, na.rm = T),
    ...
    freq_educ_3_presence_18_19.filles_13_18.12m = sum(sum_educ_3_presence_18_19.filles_13_18.3m_6m*weights_sampling, na.rm=T) / sum(sum_agegrp_13_18_filles* weights_sampling, na.rm=T),
    freq_educ_3_presence_18_19.filles_13_18.3m_6m = sum(sum_educ_3_presence_18_19.filles_13_18.6m_12m*weights_sampling, na.rm = T) / sum(sum_agegrp_13_18_filles*weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.filles_13_18.6m_12m = sum(sum_educ_3_presence_18_19.filles_13_18.12m*weights_sampling, na.rm = T) / sum(sum_agegrp_13_18_filles*weights_sampling, na.rm = T),
    ...
    freq_educ_3_presence_18_19.filles_7_12.12m = sum(sum_educ_3_presence_18_19.filles_7_12.3m_6m*weights_sampling, na.rm = T) / sum(sum_agegrp_7_12_filles*weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.filles_7_12.3m_6m = sum(sum_educ_3_presence_18_19.filles_7_12.6m_12m*weights_sampling, na.rm =T) / sum(sum_agegrp_7_12_filles*weights_sampling, na.rm=T),
    freq_educ_3_presence_18_19.filles_7_12.6m_12m = sum(sum_educ_3_presence_18_19.filles_7_12.12m*weights_sampling, na.rm = T) / sum(sum_agegrp_7_12_filles*weights_sampling, na.rm = T),
    ...
    freq_educ_3_presence_18_19.garcons_13_18.12m = sum(sum_educ_3_presence_18_19.garcons_13_18.3m_6m*weights_sampling, na.rm = T) / sum(sum_agegrp_13_18_garcons*weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons_13_18.3m_6m = sum(sum_educ_3_presence_18_19.garcons_13_18.6m_12m*weights_sampling, na.rm = T) / sum(sum_agegrp_13_18_garcons*weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons_13_18.6m_12m = sum(sum_educ_3_presence_18_19.garcons_13_18.12m*weights_sampling, na.rm = T) / sum(sum_agegrp_13_18_garcons*weights_sampling, na.rm = T),
    ...
    freq_educ_3_presence_18_19.garcons_7_12.12m = sum(sum_educ_3_presence_18_19.garcons_7_12.3m_6m*weights_sampling, na.rm=T) / sum(sum_agegrp_7_12_garcons*weights_sampling, na.rm=T),
    freq_educ_3_presence_18_19.garcons_7_12.3m_6m = sum(sum_educ_3_presence_18_19.garcons_7_12.6m_12m*weights_sampling, na.rm = T) / sum(sum_agegrp_7_12_garcons*weights_sampling, na.rm = T),
    freq_educ_3_presence_18_19.garcons_7_12.6m_12m = sum(sum_educ_3_presence_18_19.garcons_7_12.12m*weights_sampling, na.rm=T) / sum(sum_agegrp_7_12_garcons*weights_sampling, na.rm=T),
